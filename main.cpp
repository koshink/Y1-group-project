...
int main() {
    ...
    char customChars[8][8] = {  
        {0x00, 0x00, 0x0E, 0x11, 0x11, 0x11, 0x0E, 0x00}, // Electron Chase: frame 1
        {0x00, 0x0A, 0x00, 0x04, 0x00, 0x11, 0x0E, 0x00}, // Electron Chase: frame 2
        {0x00, 0x00, 0x0E, 0x15, 0x15, 0x0E, 0x00, 0x00}, // Electron Chase: frame 3
        {0x00, 0x07, 0x08, 0x10, 0x10, 0x0F, 0x06, 0x00}, // Quiz Duels: Car Left
        {0x00, 0x18, 0x06, 0x01, 0x01, 0x1F, 0x0C, 0x00}, // Quiz Duels: Car Right
